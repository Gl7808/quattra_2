...
export function createConsoleGallery(root) {
    const viewport = root.querySelector('.console-gallery__viewport');
    ...
    const originals = [...track.querySelectorAll('[data-gallery-slide]')];
    ...
    function normalize() {
        ...
        track.classList.add('console-gallery__track--instant');
        realIndex = equivalent;
        render();
        void track.offsetHeight;
        requestAnimationFrame(() => track.classList.remove('console-gallery__track--instant'));
    }
    ...
    function finishDragCleanup() {
        ...
        track.classList.remove('console-gallery__track--instant');
